...
export class Backend implements backendInterface {
    ...
    async getLastCommands(arg0: bigint): Promise<Array<[Time, string]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLastCommands(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listScripts(): Promise<Array<ScriptMetadata>> {
        if (this.processError) {
            try {
    ...
    async renameScript(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.renameScript(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveScript(arg0: string, arg1: ScriptInput): Promise<void> {
        if (this.processError) {
            try {
    ...
    async storeCommand(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storeCommand(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
