  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        ide: {
          header: "oklch(var(--ide-header))",
          "tab-active": "oklch(var(--ide-tab-active))",
          activitybar: "oklch(var(--ide-activitybar))",
          run: "oklch(var(--ide-run))",
          "run-fg": "oklch(var(--ide-run-fg))",
        },
        term: {
          output: "oklch(var(--term-output))",
          error: "oklch(var(--term-error))",
          system: "oklch(var(--term-system))",
          prompt: "oklch(var(--term-prompt))",
          keyword: "oklch(var(--term-keyword))",
          builtin: "oklch(var(--term-builtin))",
          string: "oklch(var(--term-string))",
          number: "oklch(var(--term-number))",
          operator: "oklch(var(--term-operator))",
          punctuation: "oklch(var(--term-punctuation))",
          comment: "oklch(var(--term-comment))",
        },
      },
      fontFamily: {
      ...
      boxShadow: { xs: "0 1px 2px 0 rgba(0,0,0,0.05)", ide: "0 0 0 1px oklch(var(--border)), 0 4px 16px 0 rgba(0,0,0,0.5)" },
      keyframes: {
